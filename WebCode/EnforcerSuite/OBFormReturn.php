<?php
    if(isset($_POST['arguments']) && !empty($_POST['arguments'])) {
		if($_POST['arguments']['type'] == "fetch"){
			...
			if($param == 'new'){
				$newDiv = '<h1>Name: </h1>'.
                    '<input type=&quot;text&quot; id=&quot;name&quot; /><br><br><br> <h1>UUID: </h1>'.
                    '<input type=&quot;text&quot; id=&quot;uuid&quot; /><br><br><br> <h1>Date Demoted: </h1>'.
                    '<input type=&quot;text&quot; id=&quot;demoteDate&quot; /><br><br><br> <h1>Started: </h1>'.
                    '<input type=&quot;date&quot; id=&quot;started&quot; /><br><br><hr><br><br> <h1>Enforcer: </h1> <br>'.
                    ...
                    '<input type=&quot;checkbox&quot; id=&quot;R11&quot;/>Other: '.
                    '<input id=&quot;R12&quot;/> <p></p> <br><br>'.
                    '<input type=&quot;checkbox&quot; id=&quot;RAuto&quot;/> Auto Collect Evidence<p></p><br><br><hr><h1>Evidence:</h1><br>'.
                    '<input type=&quot;text&quot; id=&quot;evidence&quot;><p></p><br><hr><h1>Notes:</h1><br>'.
                    '<textarea rows=&quot;7&quot; cols=&quot;100&quot; id=&quot;notes&quot; style=&quot;width:500px;height:200px&quot;>'.
                    '</textarea><p></p><br><button type=&quot;button&quot; onclick=&quot;Update()&quot;>Update</button>';
				echo "'".$newDiv."'";
				...
				$newDiv = '<p>'.$bginfo.'<br><hr><h1>Banned On:</h1><br>'.
                    '<input type="checkbox" id="B0"/> Build<br><br>'.
                    '<input type="checkbox" id="B1" checked/> Freebuild<br><br>'.
                    '<input type="checkbox" id="B2"/> TeamSpeak<br><br>'.
                    '<input type="checkbox" id="B3"/> Forum<a>(Not Automatic)</a><br><br>'.
                    '<input type="checkbox" id="B4"/> Other: '.
                    '<input type="text" id="B5"/><p></p><br><br>'.
                    ...
                    '<input type="checkbox" id="R0"/> Unauthorised Block Break/Place <br><br>'.
                    '<input type="checkbox" id="R1"/> Spamming Chat <br><br>'.
                    '<input type="checkbox" id="R2"/> Social Indiscretion (Inappropriate Username, Profane/Derogatory Language, Political/Religious Discussions, Referencing Vulgar/Explicit Material) <br><br>'.
                    '<input type="checkbox" id="R3"/> Ignoring Staff Direction / Impeding Work <br><br>'.
                    '<input type="checkbox" id="R4"/> Impersonating Staff Member <br><br>'.
                    '<input type="checkbox" id="R5"/> Use of Detrimental 3rd Party Mods <br><br>'.
                    '<input type="checkbox" id="R6"/> Advertising <br><br>'.
                    ...
                    '<input type="checkbox" id="RAuto"/> Auto Collect Evidence<p></p><br><br><hr><h1>Evidence:</h1><br>'.
                    '<input type="text" id="evidence"><p></p><br><hr><h1>Notes:</h1><br>'.
                    '<textarea rows="7" cols="100" id="notes" style="width:500px;height:200px"></textarea>'.
                    '<p></p>'.
                    '<!--input type="checkbox" id="done"/-->'.
                    '<br><br><button type="button" onclick="Update()">Update</button>';
				echo $newDiv;
			}
