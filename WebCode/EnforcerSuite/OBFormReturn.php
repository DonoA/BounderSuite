<?php
    if(isset($_POST['arguments']) && !empty($_POST['arguments'])) {
		if($_POST['arguments']['type'] == "fetch"){
			...
			if($param == 'new'){
				$newDiv = 'Name: <input type=text id=name /><br/><br/> '.
                  ...
                  'Date Demoted: <input type=date id=demoteDate />'.
                  '<br><br><hr> Enforcer:  <br> <select>';
        ...
        $newDiv = $newDiv.'</select>'.
                  ...
                  '<input id=R12/> <p></p> <br><br><p></p><br><br>'.
                  '<hr><h1>Evidence:</h1><br>'.
                  '<input type=text id=evidence><br/><br/>'.
                  ...
                  '</textarea><p></p><br><button type=button onclick=Reply(false)>Add</button><br/><br/><button type=button onclick=Reply(true)>Complete</button>';
				echo $newDiv;
